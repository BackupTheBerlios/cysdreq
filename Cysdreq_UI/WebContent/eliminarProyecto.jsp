...
<TR>
	...
	<TD width="80%">
		...
		<TR height="90%">
			<TD>
			    <html:errors/>
			    <html:form action="/eliminarProyecto.do">
				<table height="300" border="0" valign="center" align="center" width="80%" cellpadding=10 bgcolor="#999999">
				<tr>
					<td colspan="2">Seleccione el proyecto que desea eliminar</td>
				</tr>
				<tr>
				...
				<tr>
				    <td width="50%" align="center" colspan="2"><html:submit>Eliminar</html:submit></td>
				</tr>
				</table>
				</html:form>
			</TD>
