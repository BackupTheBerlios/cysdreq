 ...
 * @author
 */
public class FormAgregarRolProyecto extends ActionForm {
	...
	public ArrayList getAcciones() {
		...
		ArrayList tipoAcciones = TipoAccionManager.getAccionesProyecto();
	...
	public PersistentArrayList getAccionesPersistentesSeleccionadas() {
		...
		for (int i = 0; i < accionesSeleccionadas.length; i++) {
			...
			TipoAccion tipoAccion = TipoAccionManager.getAccionProyecto(nombreAccion);
